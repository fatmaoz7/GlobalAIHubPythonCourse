...
questions=["1st question:What is the capital city of Turkey? ",  #questions that will be asked
...
q=[Question(questions[0],"Ankara"),      #true answers of questions
...
def run_test(q):  #creating function to test answers
    score=0;
    for a in q:
